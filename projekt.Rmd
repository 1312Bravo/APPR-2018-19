...
ggplot(data=tockevsplaca, aes(x=Tocke, y=Placa)) + 
  ...
  geom_point(data=top5zdruzena, aes(x=Tocke, fill=tip), shape=21, size=2, show_guide=FALSE) + 
  ggtitle("Evropejci vs top 5 (Američani)") + 
  ylab("Plača  (v milijonih)") + xlab("Točke") +
  scale_colour_manual(name = "Pričakovane Točke", values=c("Evropski_standard"="red","Ameriški_standard"="green")) +
  theme_bw()
