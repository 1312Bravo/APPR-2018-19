...
```{r glede na povprecje, echo=FALSE, message=FALSE, fig.align='center', fig.cap='povezava med efektivnostjo meta in placo glede na povprecje'}
...
```{r fiba.lestvica populacija, echo=FALSE, message=FALSE, fig.align='center', fig.cap='povezava med stevilom igralcev in populacijo deljeno z 10 milijoni'}
...
```{r zemljevid, echo=FALSE, fig.align='center', warning=FALSE, fig.cap='Zemljevid stevila igralcev v posamezni drzavi'}
