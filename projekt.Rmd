...
Spodnji graf prikazuje razmerjem med plačo in odstotkom meta igralcev.

```{r glede na povprečje, echo=FALSE, message=FALSE, fig.align='center', fig.cap='povezava med plačo in odstotkom meta igralcev, glede na povprečje'}
...
Spodnji graf prikazuje povezavo številom igralcev v NBA in populacijo držav.
...
Spodnji zemljevid prikazuje število NBA igralcev v posamezni evropski državi

```{r zemljevid, echo=FALSE, fig.align='center', fig.cap='Zemljevid števila igralcev v posamezni državi'}
